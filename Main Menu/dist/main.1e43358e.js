...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var Menu = exports.Menu = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(Menu, [{
    key: "onObjectClicked",
    value: function onObjectClicked() {
    ...
    value: function create() {
      ...
      var playButton1 = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 3.5, "Logo").setDepth(1);
      var playButton2 = this.add.image(this.game.renderer.width / 1.8, this.game.renderer.height / 2, "gameButton").setDepth(1);
      ...
      playButton1.on("pointerup", function () {
        console.log("Up");
      });
      playButton1.on("pointerdown", /*this,getFromLoadScene.bind(this),*/function () {
        // window.myScene = this;
  ...
  return Menu;
}(Phaser.Scene); //,this.game.renderer.width /2, this.game.renderer.height * 20,
},{"../CST":"src/CST.js"}],"src/scenes/LogIn.js":[function(require,module,exports) {
"use strict";
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var LogIn = exports.LogIn = /*#__PURE__*/function (_Phaser$Scene) {
  _inherits(LogIn, _Phaser$Scene);
  var _super = _createSuper(LogIn);
  function LogIn() {
    _classCallCheck(this, LogIn);
    return _super.call(this, {
      key: _CST.CST.SCENES.LOGIN
    });
  }
...
var _LogIn = require("./scenes/LogIn");
...
var game = new Phaser.Game({
  width: 1520,
  height: 795,
  scene: [_LoadScene.LoadScene, _Menu.Menu, _LogIn.LogIn //, ChooseLevel
  ] //,
  //for sprite:
  /*
  render:{
...
},{"./scenes/LoadScene":"src/scenes/LoadScene.js","./scenes/Menu":"src/scenes/Menu.js","./scenes/LogIn":"src/scenes/LogIn.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
